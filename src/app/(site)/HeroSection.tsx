    ...
    return (
        <section className="w-full flex flex-col justify-center -mt-10 sm:-mt-40">
            <div className="relative w-full max-w-8xl sm:aspect-[3/2] aspect-[3/2.5] overflow-hidden">
                ...
                <div className="absolute w-full h-auto top-20 left-76 -translate-x-1/2 z-50 block md:hidden opacity-30">
                  <Image
                    src="/logowhite.svg"
                    alt="KORA Logo"
                    width={250}
                ...
                <div
                  className="hidden md:flex w-full bg-[#354024]/95 px-2 md:px-16 absolute left-0 right-0 bottom-10 z-40"
            ...
            {/* Mobile hero text block below image */}
